...
Rectangle {
    ...
    Rectangle {
        ...
        id: scrollBar
        width: 0.01 * messageView.width; radius: width / 2
        anchors{right: messageView.right; margins: radius}

        height: Math.max(messageView.height / messageView.contentHeight * messageView.height - 2 * radius, 20)
        y: messageView.contentY / messageView.contentHeight * messageView.height + radius
        visible: messageView.height < messageView.contentHeight
    }
